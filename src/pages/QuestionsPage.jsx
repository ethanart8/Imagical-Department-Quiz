...
const PAGE_HEIGHT = 3384.8369140625;
...
export default function QuestionsPage({ pageIndex }) {
  ...
  // Start bar at previous page's progress, then animate to current
  ...
  return (
    <FigmaScale height={PAGE_HEIGHT}>
      <div style={{ position: 'relative', width: '100%', height: '100%', background: '#1e1e1e' }}>
        <img
          src={logoSmall}
          alt="imagical"
          onClick={() => navigate('/')}
          style={{ position: 'absolute', left: 92.95, top: 92.95, width: 274.97, height: 87.405, objectFit: 'cover', cursor: 'pointer' }}
        />
        ...
        >
          ...
          <div style={{ position: 'relative', width: '100%', height: 46.474 }}>
            <div
              style={{
                position: 'absolute',
                inset: 0,
                border: '3.873px solid #0e5757',
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: 116.184, width: '100%' }}>
              {page.questions.map((question) => (
                <div key={question.number} style={{ display: 'flex', flexDirection: 'column', gap: 27.11 }}>
                  <p
                    style={{
                      margin: 0,
                      fontFamily: 'Inter',
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 15.491, width: '100%' }}>
                    {question.choices.map((choice, choiceIndex) => {
                      ...
                      return (
                        <div
                          ...
                          style={{ display: 'flex', alignItems: 'flex-start', gap: 35.04, cursor: 'pointer' }}
                        >
                          <div
                            style={{
                              position: 'relative',
                          ...
                          <p style={{ margin: 0, fontFamily: 'Inter', fontWeight: 300, fontSize: 54.219, color: '#fff' }}>
                            {choice}
                          </p>
                        </div>
                      );
