    ...
    <FigmaScale height={10155}>
      <div style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        <img
          src={lightbulbImg}
          alt=""
          style={{ position: 'absolute', left: 747.11, top: 231.99, width: 808, height: 938, objectFit: 'cover' }}
        />

        <img
          src={cumpledPaperImg}
          alt=""
          style={{ position: 'absolute', left: -236.57, top: 1602.78, width: 694, height: 893, objectFit: 'cover' }}
        />
